  ...
  return (
    <header className="sticky top-0 z-50 border-b border-nile-ink/8 bg-sand/90 backdrop-blur-md">
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between gap-3 px-4 sm:h-16 sm:px-6">
        <Link
          href="/"
          className="group flex min-w-0 items-center gap-2.5 transition-transform duration-150 hover:scale-[1.02] active:scale-[0.98]"
          aria-label="Nile Packs home"
        >
          <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-nile text-sand shadow-sm transition-all duration-200 group-hover:bg-nile-deep group-hover:shadow-md group-hover:shadow-nile/30">
        ...
        <nav className="flex shrink-0 items-center gap-1 sm:gap-2">
          <Link
            href="/packages"
            className="inline-flex min-h-11 items-center rounded-full px-3 py-2 text-sm font-medium text-nile-ink/80 transition-all duration-150 hover:bg-nile/10 hover:text-nile hover:underline hover:decoration-nile/40 hover:underline-offset-4 sm:px-4"
          >
            Catalog
          </Link>
          <Link
